...
exports.createAlignmentStatusBar = createAlignmentStatusBar;
exports.updateAlignmentStatusBar = updateAlignmentStatusBar;
const vscode = __importStar(require("vscode"));
let statusBarItem;
function createAlignmentStatusBar(context) {
...
function updateAlignmentStatusBar(score) {
