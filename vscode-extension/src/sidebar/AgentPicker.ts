...
export class AgentPickerProvider implements vscode.TreeDataProvider<Agent> {
    ...
    private loadAgents() {
        ...
        this.agents = [
            { name: '👔 CTO', tier: 0, description: 'Strategic technical decisions', filename: '01-CTO.md' },
            { name: '🏗️ Architect', tier: 1, description: 'System design and patterns', filename: '02-ARCHITECT.md' },
            { name: '🔧 Backend', tier: 2, description: 'API and server development', filename: '03-BACKEND.md' },
            { name: '🎨 Frontend', tier: 2, description: 'UI/UX development', filename: '04-FRONTEND.md' },
            { name: '🗄️ Database', tier: 2, description: 'Data modeling and queries', filename: '05-DATABASE.md' },
            { name: '🔐 Security', tier: 1, description: 'Security audits and hardening', filename: '06-SECURITY.md' },
            { name: '☁️ DevOps', tier: 1, description: 'CI/CD and infrastructure', filename: '07-DEVOPS.md' },
            { name: '🧪 QA', tier: 2, description: 'Testing and quality assurance', filename: '08-QA.md' },
            { name: '📚 Docs', tier: 2, description: 'Documentation and guides', filename: '09-DOCS.md' },
            { name: '🚀 Performance', tier: 1, description: 'Optimization and profiling', filename: '10-PERFORMANCE.md' },
            { name: '♿ Accessibility', tier: 2, description: 'A11y compliance', filename: '11-ACCESSIBILITY.md' },
            ...
            { name: '💳 Payments', tier: 1, description: 'Payment integrations', filename: '14-PAYMENTS.md' },
            { name: '📊 Analytics', tier: 2, description: 'Analytics and tracking', filename: '15-ANALYTICS.md' },
            { name: '🔧 Debug', tier: 2, description: 'Debugging and troubleshooting', filename: '16-DEBUG.md' },
        ];
    }
...
Focus on ${agent.description.toLowerCase()}.`;
        ...
        vscode.window.showInformationMessage(`Ask ${agent.name} prompt ready! Paste into your AI tool.`);
    }
}
