...
class CustomerSupportAgent {
  ...
  getMetrics() {
    ...
    const avgResolutionTime = conversations.reduce((sum, conv) => {
  ...
  const supportAgent = new CustomerSupportAgent({
    ...
    knowledgeBase: [
      ...
      },
      {
        ...
        content: 'For billing questions, please contact our billing department at billing@example.com or call 1-800-123-4567.',
        category: 'billing',
