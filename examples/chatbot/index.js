...
class Chatbot {
  ...
  async processMessage(userId, message, options = {}) {
    ...
    try {
      ...
      return {
        response:
          "I apologize, but I'm experiencing technical difficulties. Could you please try rephrasing your question?",
        intent: 'error',
        entities: [],
        confidence: 0,
        sources: [],
...
async function main() {
  ...
  try {
    ...
    // Process a follow-up
    const followUpResponse = await chatbot.processMessage(
      'user123',
