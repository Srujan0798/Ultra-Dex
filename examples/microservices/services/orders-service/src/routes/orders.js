...
module.exports = (pool, redis, channel) => {
  ...
  // Order routes
  router.get('/orders/:id', authenticateToken, (req, res) => orderController.getOrder(req, res));

  router.post('/orders', authenticateToken, (req, res) => orderController.createOrder(req, res));

  router.put('/orders/:id', authenticateToken, (req, res) => orderController.updateOrder(req, res));
