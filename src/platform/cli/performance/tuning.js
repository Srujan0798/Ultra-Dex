...
class PerformanceTracker {
  ...
  recordOperation(success, responseTime, tokens = 0) {
    ...
    if (success) {
      ...
      this.metrics.avgResponseTime = this.metrics.totalResponseTime / this.metrics.successfulOperations;
  ...
  getSummary() {
    ...
    const avgResponseTime = this.metrics.successfulOperations > 0
