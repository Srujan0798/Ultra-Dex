    ...
    if (query) {
      ...
      results = results.filter(
        (t) =>
          ...
          t.tags?.some((tag2) => tag2.includes(q))
      );
    }
    return results;
  }
...
TemplateRegistry = __decorateClass([singleton()], TemplateRegistry);
...
TemplateBuilder = __decorateClass([singleton()], TemplateBuilder);
var agent_templates_default = {
  TemplateRegistry,
  TemplateBuilder,
  validateTemplate,
  builtInTemplates,
