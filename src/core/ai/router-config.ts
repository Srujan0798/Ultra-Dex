...
const STRATEGY_PROVIDER_PRIORITIES = {
  cost: [
    'deepseek',
    'groq',
    'together',
...
const PROVIDER_PRIORITY_CONFIG = {
...
function resolveOverrides(taskDescription, overrides = []) {
...
export {
  ...
  STRATEGY_PROVIDER_PRIORITIES,
  router_config_default as default,
  loadRouterConfig,
  loadRouterConfigSync,
  mergeConfig,
  resolveOverrides,
