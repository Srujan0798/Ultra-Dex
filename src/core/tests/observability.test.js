...
describe('Trace', () => {
    it('should build a trace with spans', () => {
        ...
        const child = new Span({ traceId: 't1', spanId: 'child', parentSpanId: 'root', operation: 'llm-call', agentId: 'a1' });
        trace.addSpan(root);
        trace.addSpan(child);
    ...
    it('should calculate span depth', () => {
        ...
        trace.addSpan(new Span({ traceId: 't1', spanId: 'c1', parentSpanId: 'r', operation: 'child', agentId: 'a1' }));
        trace.addSpan(new Span({ traceId: 't1', spanId: 'gc', parentSpanId: 'c1', operation: 'grandchild', agentId: 'a1' }));
...
describe('TraceCollector', () => {
    ...
    it('should manage spans within a trace', () => {
        ...
        tc.recordTokens(traceId, childSpan, { promptTokens: 100, completionTokens: 50, costPerToken: 0.00001 });
    ...
    it('should emit events', () => {
        const tc = new TraceCollector();
        let started = false;
        tc.on('trace:start', () => { started = true; });
        tc.startTrace({ agentId: 'a1' });
