...
// Swarm - Basic swarm agent functionality
...
/**
 * Swarm
 * Represents a collection of agents working together as a swarm
 */
export class Swarm extends BaseAgent {
  ...
  async executeHierarchical(task) {
    const leaders = Array.from(this.members.values())
