...
// Architect Graph - Agent architecture graph definitions

import { GraphUtils } from './graph-utils.js';

/**
 * ArchitectGraph
 * Defines and manages the architecture graph of agent systems
 */
export class ArchitectGraph {
  constructor() {
  ...
  createHierarchicalPattern(hierarchy) {
    // hierarchy: { parent: 'id', children: ['id1', 'id2', ...] }
