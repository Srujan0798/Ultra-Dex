...
const CollapsibleDiff = ({ title, diffContent, initiallyExpanded = false }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      Box,
      { onClick: toggleExpand, flexDirection: 'row', alignItems: 'center' },
      isExpanded
        ? /* @__PURE__ */ React.createElement(ChevronDown, null)
        : /* @__PURE__ */ React.createElement(ChevronRight, null),
      /* @__PURE__ */ React.createElement(Text, { bold: true, onClick: toggleExpand }, title)
    ),
    isExpanded &&
      /* @__PURE__ */ React.createElement(
        Box,
        ...
        /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(
            Static,
            { items: diffContent.split('\n') },
            (line, index) =>
              /* @__PURE__ */ React.createElement(
                Box,
                { key: index },
                line.startsWith('+')
                  ? /* @__PURE__ */ React.createElement(Text, { color: 'green' }, line)
                  : line.startsWith('-')
                    ? /* @__PURE__ */ React.createElement(Text, { color: 'red' }, line)
                    : /* @__PURE__ */ React.createElement(Text, null, line)
              )
          )
        )
      )
