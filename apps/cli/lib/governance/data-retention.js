...
class DataRetentionManager {
  ...
  async runFullCleanup() {
    ...
    results.analytics = await this.cleanupExpiredData(RETENTION_CATEGORIES.ANALYTICS, analyticsFiles);
  ...
  checkRetention(category, dataTimestamp) {
    ...
    return {
      ...
      daysUntilExpiry: cutoff ? Math.ceil((new Date(dataTimestamp) - cutoff) / (24 * 60 * 60 * 1000)) : null
    };
  }
}
