...
export async function createLineChart(
  ...
  options: { height?: number; width?: number; pointChar?: string; lineChar?: string } = {}
): Promise<string> {
...
export async function createGauge(
  ...
  maxValue: number,
  label: string = '',
  options: { width?: number; filledChar?: string; emptyChar?: string; showValues?: boolean } = {}
): Promise<string> {
...
export async function createHeatmap(
  ...
  const getColor = (value: number): chalk.Chalk => {
...
export async function createTree(
  nodes: Array<{ name: string; children?: Array<Record<string, unknown>>; level?: number }>,
  options: { indentChar?: string; expandChar?: string; lastChar?: string } = {}
): Promise<string> {
 ...
 */
export async function formatChartTitle(title: string): Promise<string> {
