...
const FileSelector = ({ files, onSelect, title = 'Select a file:' }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Text, { bold: true }, title),
    /* @__PURE__ */ React.createElement(ArrowMenu, {
      items: files,
      onSelect: handleSelect,
      initialIndex: 0,
    }),
    selectedFile &&
      /* @__PURE__ */ React.createElement(Text, { color: 'green' }, 'Selected: ', selectedFile)
  );
};
