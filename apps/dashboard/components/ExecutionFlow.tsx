...
import { FiClock, FiCheckCircle, FiXCircle, FiAlertTriangle, FiInfo, FiPlay, FiPause, FiRefreshCw } from 'react-icons/fi';
...
const ExecutionFlow = ({ executionData = null }) => {
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case 'running': return <FiPlay className="text-blue-500 animate-spin" />;
    ...
    <div className="w-full">
      ...
      <div className="mb-8">
        <div className="flex justify-between text-sm text-gray-600 mb-1">
          <span>{data.completedSteps} of {data.totalSteps} steps completed</span>
