      ...
      <header className="p-4 border-b border-gray-800 flex justify-between items-center">
        ...
        <div className="flex gap-4 text-sm text-gray-400" aria-label="Language Legend">
          <span className="flex items-center">
            <span className="w-3 h-3 bg-[#3178c6] mr-2" aria-hidden="true"></span>TS
          </span>
          <span className="flex items-center">
            <span className="w-3 h-3 bg-[#61dafb] mr-2" aria-hidden="true"></span>React
          </span>
          <span className="flex items-center">
            <span className="w-3 h-3 bg-[#f7df1e] mr-2" aria-hidden="true"></span>JS
          </span>
        </div>
      </header>
