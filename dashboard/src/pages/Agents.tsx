          ...
          {agents.map((agent) => (
            ...
            >
              ...
              <div className="text-right">
                <div className={`inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs ${statusStyles[agent.status]}`}>
                  {agent.status}
                </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 lg:col-span-2">
          <div className="flex items-center justify-between">
            ...
            <div className="text-xs uppercase tracking-[0.2em] text-slate-500">Requests</div>
          </div>
          <Chart
            data={throughputData}
            xKey="hour"
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6">
          ...
          <div className="mt-6 space-y-4">
            {[
              ...
              <div key={item.label} className="flex items-center justify-between rounded-xl border border-slate-800 bg-slate-950/50 p-4">
                <div className="flex items-center gap-3">
