...
const Dashboard = () => {
  ...
  // TaskCard Component
  const TaskCard = ({ task, agent, status, time }) => {
    const statusColors = {
  ...
  const ActivityItem = ({ timestamp, commits, aiRequests, errors }) => (
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-semibold">Ultra-Dex Dashboard</h1>
            </div>
      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-gray-800 border-r border-gray-700 min-h-screen">
          <nav className="p-4 space-y-2">
            {[
              { icon: Activity, label: 'Overview', active: activeTab === 'overview' },
              { icon: Bot, label: 'Agents', active: activeTab === 'agents' },
              ...
              { icon: GitCommit, label: 'Commits', active: activeTab === 'commits' },
            ].map((item, index) => (
              <button
                key={index}
        ...
        <main className="flex-1 p-6">
          ...
          {/* Recent Tasks and Real-time Activity */}
