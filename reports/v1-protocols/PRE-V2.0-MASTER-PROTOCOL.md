# Ultra-Dex Pre-V2.0 Master Protocol

> **Single source of truth. No repetition. Execute in order.**

**Generated:** 2026-04-03  
**Source:** User Master Document + UD_2 + UD_4 + UD_5  
...
# PART 1: STABILIZATION PROTOCOL (19 PHASES)
...
**Tests passing ≠ system working. Green CI ≠ real execution.**
...
# PART 2: MULTI-WINDOW AGENT ORCHESTRATION

---

## USE 4 WINDOWS IN PARALLEL

Each has a single role. Do not mix.

---

### WINDOW 1 — CONTROLLER (CTO)
...
# PART 3: V2.0 VISION + FEATURE BACKLOG
...
```
P0 → Execution (run.js, provider, agent loop)
P1 → Logging + trace
P2 → Tools + memory
P3 → UI / CLI aesthetics (LAST)
```

---

## EXECUTION FLOW (Required Path)
