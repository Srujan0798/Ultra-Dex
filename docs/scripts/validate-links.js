...
async function readMarkdownFiles(dir) {
  ...
  for (const dirent of dirents) {
    ...
    if (dirent.isDirectory()) {
      if (dirent.name !== 'node_modules' && dirent.name !== '.git' && dirent.name !== '.ultra-dex') {
...
export { readMarkdownFiles, extractLinks, isInternalLink, resolveRelativePath, validateFileLinks, validateAllLinks };