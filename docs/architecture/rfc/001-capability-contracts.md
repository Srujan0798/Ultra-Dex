...
Currently, a plugin like `write_code` declares _what input it needs_ (filePath, content) but not _what damage it can do_ (Write Access, Infinite Loops, High Token Costs).
