...
export class TemplateBuilder {
    ...
    id(id) { this._template.id = id; return this; }
    name(name) { this._template.name = name; return this; }
    description(desc) { this._template.description = desc; return this; }
    category(cat) { this._template.category = cat; return this; }
    role(role) { this._template.role = role; return this; }
    model(model) { this._template.model = model; return this; }
    systemPrompt(prompt) { this._template.systemPrompt = prompt; return this; }

    addCapability(cap) { this._template.capabilities.push(cap); return this; }
    addTool(tool) { this._template.tools.push(tool); return this; }
    addConstraint(c) { this._template.constraints.push(c); return this; }
    addTag(tag) { this._template.tags.push(tag); return this; }
    setConfig(key, value) { this._template.config[key] = value; return this; }
