...
[**SKILL.md](http://skill.md/) Template**: See `references/skill-template.md`
...
Read the current [SKILL.md](http://skill.md/) and reference files to understand what's already documented.
...
2. Update [SKILL.md](http://skill.md/)'s "Knowledge Base Navigation" section to include the new domain
...
- [ ]  [SKILL.md](http://skill.md/) has complete frontmatter (name, description)
...
- [ ]  Reference files are linked from [SKILL.md](http://skill.md/) navigation section
