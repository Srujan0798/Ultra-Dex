...
description: Draft a polished Slack announcement and create it as a draft message in Slack. Use when the user needs to post an announcement to a channel and wants help with formatting, tone, and getting it ready in Slack.
argument-hint: "<announcement topic or context>"
---
...
Draft a polished Slack announcement and create it as a draft message in Slack.

## Usage

```
/announcement-draft $ARGUMENTS
```
