---
name: channel-digest
description: Summarize recent activity across multiple Slack channels into a concise digest. Use when the user wants a quick overview of what's happening in specific channels without reading every message.
argument-hint: "<comma-separated channel names>"
---
...
Summarize recent activity across multiple Slack channels into a concise digest.

## Usage

```
/channel-digest $ARGUMENTS
```
