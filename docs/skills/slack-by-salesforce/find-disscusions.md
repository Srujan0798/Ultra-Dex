...
description: Search Slack for discussions on a specific topic and summarize the conversations found. Use when the user wants to know what has been discussed about a topic across Slack channels.
...
Search Slack for discussions on a specific topic and summarize the conversations found.

## Usage

```
/search-discussions $ARGUMENTS
```
