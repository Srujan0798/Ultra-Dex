---
name: standup
description: Generate a daily standup update for the current user based on their recent Slack activity. Use when the user wants a quick summary of what they did, what they're doing next, and any blockers based on their Slack messages.
argument-hint: ""
---
...
Generate a daily standup update for the current user based on their recent Slack activity.
