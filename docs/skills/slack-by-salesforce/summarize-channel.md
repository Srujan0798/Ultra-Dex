...
description: Summarize recent activity in a single Slack channel. Use when the user wants a quick overview of what happened in a specific channel without scrolling through all messages.
...
Summarize recent activity in a single Slack channel.

## Usage

```
/channel-summary $ARGUMENTS
```
