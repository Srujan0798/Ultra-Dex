---
name: brainstorm
description: Brainstorm a product topic with a sharp, opinionated thinking partner. Use when exploring a problem space, generating product ideas, stress-testing assumptions, or when a PM needs to think out loud with a sparring partner before converging on a direction.
