# Built with Ultra-Dex

> Projects built using the Ultra-Dex framework
...
Built something with Ultra-Dex? Add it here!

### How to Submit

1. Fork this repository
2. Add your project to the table below
3. Submit a Pull Request

### Project Template

```markdown
| [Your Project Name](link) | Brief description | Your Stack | [Your Name](github) |
```
...
- Get visibility for your project
- Inspire others building with Ultra-Dex
