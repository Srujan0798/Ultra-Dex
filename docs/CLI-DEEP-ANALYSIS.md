...
**The Secret Sauce:** *The REPL (Read-Eval-Print Loop).*
...
*   **The "Double Loop":**
    1.  **Plan:** It tells you what it *wants* to do.
    2.  **Confirm:** You press Enter.
    3.  **Execute:** It runs shell commands *for you*.
...
**The Secret Sauce:** *The Diff View.*
