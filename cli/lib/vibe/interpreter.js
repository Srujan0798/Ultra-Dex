...
function detectMode(input, currentMode = 'create') {
  ...
  if (lower.startsWith('explain') || lower.startsWith('what does') || lower.startsWith('describe')) {
    return 'explain';
  }
  if (lower.startsWith('debug') || lower.includes('why is') || lower.includes('error')) {
    return 'debug';
  }
  if (lower.startsWith('change') || lower.startsWith('update') || lower.startsWith('modify') || lower.includes('make this')) {
    return 'modify';
  }
