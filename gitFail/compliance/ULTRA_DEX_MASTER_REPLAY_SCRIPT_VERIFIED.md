...
- Global ESLint: FAIL (`npx eslint . --quiet`) => 641 errors across 81 files
...
3. Global lint is not clean:
   - 641 ESLint errors remain; top rules: `no-undef`, `no-prototype-builtins`, `no-useless-escape`.
...
1. ESLint debt burn-down (641 errors across 81 files).
